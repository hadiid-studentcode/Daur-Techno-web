      ...
      <section>
        <div class="container bg-primary-gradient py-5">
          ...
          <div class="py-5 p-lg-5">
            <div
              class="row row-cols-1 row-cols-md-2 mx-auto sc1"
            ...
            >
              <div class="col mb-5">
                <div class="card shadow-sm">
                  <div class="card-body px-4 py-5 px-md-5">
                    <div
                      class="bs-icon-lg d-flex justify-content-center align-items-center mb-3 bs-icon sc2"
                    >
                      <svg
              ...
              <div class="col mb-5">
                <div class="card shadow-sm">
                  <div class="card-body px-4 py-5 px-md-5">
                    <div
                      class="bs-icon-lg d-flex justify-content-center align-items-center mb-3 bs-icon sc3"
